...
div.post, div.page, #comments, .comments, .column-text, .column-image, #srights, #slefts, #frontpage blockquote, .page-title, .page-header, article.post, article.page,
.contentsearch, #author-info, #nav-below, .yoyo > li
     { background-color: <?php echo $parabola_contentcolorbg; ?>; }
div.post, div.page, .sidey .widget-container, #comments, .commentlist .comment-body, article.post, article.page, #nav-below, .page-header, .yoyo > li
...
<?php if (cryout_hex2rgb($parabola_accentcolorb)): ?>article.sticky { border-color: rgba(<?php echo cryout_hex2rgb($parabola_accentcolorb); ?>,0.2); }<?php endif; ?>
...
input[type="text"]:hover, input[type="password"]:hover, input[type="email"]:hover, textarea:hover {
	<?php if(cryout_hex2rgb($parabola_accentcolore)): ?>background-color: rgba(<?php echo cryout_hex2rgb($parabola_accentcolore); ?>,0.4); <?php endif; ?> }
.entry-content code {
	border-color: <?php echo $parabola_accentcolord; ?>;
	background-color: <?php echo $parabola_accentcolore; ?>; }
...
.caption-accented .wp-caption {<?php if(cryout_hex2rgb($parabola_accentcolora)):?> background-color:rgba(<?php echo cryout_hex2rgb($parabola_accentcolora);?>,0.8); <?php endif; ?>
	color:<?php echo $parabola_contentcolorbg;?>}
...
.column-image h3, #front-columns h3.column-header-noimage, .tinynav { text-transform: none; }<?php endif; ?>
